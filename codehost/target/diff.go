...
func parseFilePatchLines(lines []string) ([]*diffBlock, error) {
	...
	currentLine := 0
	numAdded, numRemoved := int64(0), int64(0)
...
func parseVersionSection(section string) (int64, int64, error) {
	...
	replyLine := int64(math.Abs(float64(line)))
	if len(blocks) < 2 {
